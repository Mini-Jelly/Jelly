<nav id="nav" class="nav">
  <div class="nav-content">
    ...
    <form class="nav-form" method="post" action="<?php $this->options->siteUrl(); ?>">
      ...
      <input name="s" class="nav-form-input" id="nav-form-input" placeholder="Search"
  ...
  <div class="nav-menu-trigger">
    <button id="nav-menu-trigger-button" class="nav-menu-trigger-button"
            aria-label="nav-menu-trigger-button"
            role="button">
      <svg width="18" height="18" viewBox="0 0 18 18">
        <polyline id="nav-menu-trigger-bread-bottom"
                  class="nav-menu-trigger-bread nav-menu-trigger-bread-bottom" fill="none"
                  stroke="currentColor"
                  stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"
                  points="2 12, 16 12">
          <animate id="nav-anim-menu-trigger-bread-bottom-open" attributeName="points"
                   keyTimes="0;0.5;1"
                   dur="0.24s" begin="indefinite" fill="freeze" calcMode="spline"
                   keySplines="0.42, 0, 1, 1;0, 0, 0.58, 1"
                   values=" 2 12, 16 12; 2 9, 16 9; 3.5 15, 15 3.5">
          </animate>
          <animate id="nav-anim-menu-trigger-bread-bottom-close" attributeName="points"
                   keyTimes="0;0.5;1"
                   dur="0.24s" begin="indefinite" fill="freeze" calcMode="spline"
                   keySplines="0.42, 0, 1, 1;0, 0, 0.58, 1"
        ...
        <polyline id="nav-menu-trigger-bread-top"
                  class="nav-menu-trigger-bread nav-menu-trigger-bread-top"
                  fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"
                  stroke-linejoin="round" points="2 5, 16 5">
          <animate id="nav-anim-menu-trigger-bread-top-open" attributeName="points"
                   keyTimes="0;0.5;1"
                   dur="0.24s" begin="indefinite" fill="freeze" calcMode="spline"
                   keySplines="0.42, 0, 1, 1;0, 0, 0.58, 1"
                   values=" 2 5, 16 5; 2 9, 16 9; 3.5 3.5, 15 15">
          </animate>
          <animate id="nav-anim-menu-trigger-bread-top-close" attributeName="points"
                   keyTimes="0;0.5;1"
                   dur="0.24s" begin="indefinite" fill="freeze" calcMode="spline"
                   keySplines="0.42, 0, 1, 1;0, 0, 0.58, 1"
